...
$workexp = [
    [
        ...
        'workperiod' => 'Jan 2015 - ',
        'responsibilities' => 'Lorem ipsum dolor sit amet. Praesentium magnam consectetur vel in deserunt aspernatur est reprehenderit
      sunt hic. Nulla tempora soluta ea et odio, unde doloremque repellendus iure, iste.'
    ],
    [
        'post' => 'Web Developer / something.com',
        'workperiod' => 'Mar 2012 - Dec 2014',
        'responsibilities' => 'Consectetur adipisicing elit. Praesentium magnam consectetur vel in deserunt aspernatur est reprehenderit
        sunt hic. Nulla tempora soluta ea et odio, unde doloremque repellendus iure, iste.'
    ],
    [
        'post' => 'Graphic Designer / designsomething.com',
        'workperiod' => 'Jun 2010 - Mar 2012',
                        ...
                        <?php for ($i = 0; $i < count($skills); $i++): ?>
                            ...
                            <div class="w3-light-grey w3-round-xlarge w3-small">
                                <div class="w3-container w3-center w3-round-xlarge w3-teal"
                                    style="width:<?php echo $skills[$i]['percent']; ?>%"><?php echo $skills[$i]['percent']; ?>%</div>
                            </div>
                        <?php endfor; ?>
                        <br>

                        <p class="w3-large w3-text-theme"><b><i
                                    class="fa fa-globe fa-fw w3-margin-right w3-text-teal"></i>Языки</b>
                        </p>
                        <p>Английский</p>
                    ...
                    <div class="w3-container">
                        <?php for ($i = 0; $i < count($workexp); $i++): ?>
                            <h5 class="w3-opacity"><b>
                                    <?php echo $workexp[$i]['post']; ?>
                                </b></h5>
                            <?php if ($i == 0): ?>
                                <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>
                                    <?php echo $workexp[$i]['workperiod']; ?><span
                                        class="w3-tag w3-teal w3-round">Current</span>
                                </h6>
                            <?php else: ?>
                                <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>
                                    <?php echo $workexp[$i]['workperiod']; ?>
                                </h6>
                            <?php endif; ?>
                            <p>
                                <?php echo $workexp[$i]['responsibilities']; ?>
                            </p>
                            <hr>
                        <?php endfor; ?>
                    </div>
